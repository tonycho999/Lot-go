...
// 1. Setup Mode 0 (2/4 cards, cost 100, max 500)
...
if (Game.state.gold !== 900) throw new Error("Cost not deducted");
...
if (result2.prize !== 500) throw new Error(`Perfect game prize wrong. Expected 500, got ${result2.prize}`);
...
// Formula: 500 * ((4-3)/(4-2))^2 = 500 * (1/2)^2 = 500 * 0.25 = 125
if (finalRes.prize !== 125) throw new Error(`Imperfect game prize wrong. Expected 125, got ${finalRes.prize}`);
